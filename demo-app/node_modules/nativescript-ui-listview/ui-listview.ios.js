...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.updateHeaderFooter = function () {
        if (this.nativeViewProtected && this.nativeViewProtected.layout) {
            ...
            if (tempView) {
                this.updateChildrenIosOverflowSafeAreaRecursive(tempView);
    ...
    RadListView.prototype.prepareLoadOnDemandCell = function (cell, indexPath) {
        if (cell.view === undefined) {
            ...
            if (loadOnDemandView) {
                ...
                this.updateChildrenIosOverflowSafeAreaRecursive(cell.view);
    ...
    // TODO: This is a workaround to an issue in tns-core-modules.
    // Right now any element inside a template of ListView or RadListView cannot support
    // iosOverflowSafeArea = true.
    // Remove this when it is fixed in default ListView
    RadListView.prototype.updateChildrenIosOverflowSafeAreaRecursive = function (parentView) {
        if (parentView) {
            parentView.iosOverflowSafeArea = false;
            var that_1 = this;
            parentView.eachChildView(function (childView) {
                if (childView instanceof layout_base_1.LayoutBase) {
                    that_1.updateChildrenIosOverflowSafeAreaRecursive(childView);
                }
                else {
                    childView.iosOverflowSafeArea = false;
                }
                return true;
            });
        }
    ...
    RadListView.prototype.prepareCell = function (tableCell, indexPath, templateType, raiseItemLoadingEvent) {
        ...
        if (cell.view === undefined) {
            ...
            this.updateChildrenIosOverflowSafeAreaRecursive(cell.view.itemView);
            this.updateChildrenIosOverflowSafeAreaRecursive(cell.view.swipeView);
            this.prepareCellTag(cell);
            if (this.reorderMode && this.reorderMode.toLowerCase() === commonModule.ListViewReorderMode.Drag) {
